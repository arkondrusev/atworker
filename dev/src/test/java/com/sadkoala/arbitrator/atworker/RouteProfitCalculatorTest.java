...
public class RouteProfitCalculatorTest {
    ...
    public void calcRouteProfitTest() {
        ...
        StockExchange binanceSe = Global.findSeByName("binance").get();
        ...
        priceSliceList.add(pairPriceSlice);
        RoutePriceSliceProfit routePriceSliceProfit = RouteProfitCalculator.calcRouteProfit(binanceSe,
        ...
        pairPriceSlice.setPair(Global.findPairByTokenNames("BTC", "USDT").get());
        priceSliceList.add(pairPriceSlice);
        routePriceSliceProfit = RouteProfitCalculator.calcRouteProfit(binanceSe,
                Global.findRouteByTokenNames(token1, token2, token3).get(),
                priceSliceList);
    ...
    public void doTradeTest() {
        ...
        BigDecimal2 tradeFeeMultiplier = BigDecimal2.ONE.subtract(Global.findSeByName("binance").get().getTradeFee());
